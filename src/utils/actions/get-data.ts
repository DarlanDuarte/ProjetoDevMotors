...
export async function getDataHome(){
  ...
  try{
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/objects/6629671b110003f9e3bf5873?read_key=${process.env.READ_KEY}&depth=1&props=slug,title,metadata`, {next: {revalidate: 120}})
